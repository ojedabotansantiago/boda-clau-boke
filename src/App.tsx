...
function App() {
  ...
  const subtitle = 'Dia 11 de Septiembre de 2021 a las 12:15';
  ...
  const sectionEntryPalace: SectionEntryProp = {
    ...
    secondaryText: {
      isLink: true,
      text: 'Selecciona este enlace para obtener más información acerca de la Finca San Antonio',
  ...
  const sectionEntryTransportChurch: SectionEntryProp = {
    ...
    mainText: 'Para el desplazamiento de la iglesia a la finca se habilitarán autobuses que saldrán aproximadamente a las 13:45',
  };
  const sectionEntryTransportPalace: SectionEntryProp = {
    ...
    'Para cerrar la celebración y este día tan especial, al finalizar la barra libre dispondréis de autobuses a Las Rozas de Madrid \
     y hacia la calle Doctor Esquerdo cruce con Sainz de Baranda en Madrid centro',
  };
  ...
  const sectionEntryForm: SectionEntryProp = {
    ...
    mainText:
      'Con el fin de agilizar los temas de transporte y asistencia os dejamos un formulario de contacto para que nos indiquéis vuestras preferencias',
    secondaryText: {
      isLink: true,
      text: 'ES24-0073-0100-5005-9240-4249',
      src: 'https://goo.gl/maps/bmHfummf3WvNVRjY7',
